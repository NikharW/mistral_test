...
python batch_eval.py --model-config configs/model_$MODEL_NUM.json --quant-config configs/baseline-config.json --dataset "legacy-datasets/wikipedia" --num-samples 10000 --batch-size $BATCH_SIZE
